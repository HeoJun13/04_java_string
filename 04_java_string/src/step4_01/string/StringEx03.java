...
public class StringEx03 {
	...
	public static void main(String[] args) {
		...
		char ch = str.charAt(2);// (중요) charAt메서드의 결과는 char 자료형
		...
		System.out.println(strData1.compareTo(strData2)); // -3  왼쪽데이터(기준)이 작을 경우 음수가 반환된다.
		System.out.println(strData2.compareTo(strData1)); // 3   왼쪽데이터(기준)이 클   경우 양수가 반환된다.
 		System.out.println(strData1.compareTo(strData3)); // 0   양쪽데이터가 같을 경우 0이 반환된다.
